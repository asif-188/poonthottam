        ...
        const content = `
            ...
            <body onload="window.print(); window.close();">
                ...
                <div class="details">
                    ...
                    <div><span>Customer:</span> <span>${record.customerName}</span></div>
                ...
                <div style={{ pointerEvents: staffId ? 'auto' : 'none', opacity: staffId ? 1 : 0.5, transition: 'all 0.3s' }}>
                    ...
                    <div style={{ background: '#fffbeb', borderRadius: '16px', border: '1.5px solid #fef3c7', padding: '16px', marginBottom: '24px' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr auto', gap: '12px', alignItems: 'end' }}>
                            ...
                            <div>
                                <label style={LABEL_S}>{lang === 'ta' ? 'அளவு (Kg)' : 'Qty (Kg)'}</label>
                                <input
                                    ref={refQty}
                                    type="number"
                                    inputMode="decimal"
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        {lastSavedRecord && (
                            <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                                ...
                                >
                                    <Printer size={16} /> {lang === 'ta' ? 'அச்சிடு' : 'Print Invoice'}
                                </button>
                                <button
